...
interface SelectStudentBonusModalProps {
  onClose: () => void;
}
...
const SelectStudentBonusModal = ({ onClose }: SelectStudentBonusModalProps) => {
        ...
        >
          ...
          {isLoading ? (
            ...
            <div className="space-y-4 overflow-y-auto flex-1">
              ...
              {/* Reason */}
              <div>
                <Label className="text-sm font-medium mb-1 block">Lý do cộng điểm</Label>
                <Input
                  value={reason}
...
export default SelectStudentBonusModal;
